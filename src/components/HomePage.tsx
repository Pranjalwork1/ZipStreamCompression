...
export const HOME_TOOLS: ToolItem[] = [
  ...
  // 2. CONVERT TO PDF
  {
    ...
    description: 'Turn photos, screenshots, and image files into a multi-page PDF with one click.',
    badge: 'Free',
    colorScheme: {
      bg: 'bg-pink-500/5 dark:bg-pink-500/10',
      border: 'border-pink-500/20 dark:border-pink-500/30',
    ...
    icon: <ImageIcon className="w-5 h-5 text-[#ff2d55]" />,
    keywords: ['jpg to pdf', 'image to pdf', 'photo to pdf', 'png to pdf'],
  },
  {
    id: 'word_to_pdf',
    name: 'Word to PDF',
    category: 'convert-compress',
    categoryLabel: 'Convert to PDF',
    description: 'Convert Microsoft Word DOCX and DOC files to PDF right in your browser.',
    badge: 'DOCX',
    colorScheme: {
      bg: 'bg-blue-500/5 dark:bg-blue-500/10',
      border: 'border-blue-500/20 dark:border-blue-500/30',
    ...
    icon: <FileText className="w-5 h-5 text-[#0071e3]" />,
    keywords: ['word to pdf', 'docx to pdf', 'word document', 'microsoft word'],
  },
  {
    id: 'pptx_to_pdf',
    ...
    category: 'convert-compress',
    categoryLabel: 'Convert to PDF',
    description: 'Export all slides of a PPTX presentation into a clean, shareable PDF file.',
    badge: 'PPTX',
    colorScheme: {
    ...
    icon: <Presentation className="w-5 h-5 text-[#ff9500]" />,
    keywords: ['powerpoint to pdf', 'pptx to pdf', 'presentation to pdf', 'slides'],
  },
  {
    id: 'xlsx_to_pdf',
    name: 'Excel to PDF',
    category: 'convert-compress',
    categoryLabel: 'Convert to PDF',
    description: 'Convert Excel XLSX spreadsheets into a clean, well-structured PDF document.',
    badge: 'XLSX',
    colorScheme: {
      bg: 'bg-emerald-500/5 dark:bg-emerald-500/10',
      border: 'border-emerald-500/20 dark:border-emerald-500/30',
    ...
    icon: <FileSpreadsheet className="w-5 h-5 text-[#34c759]" />,
    keywords: ['excel to pdf', 'xlsx to pdf', 'spreadsheet to pdf', 'xls'],
  },
  {
    id: 'html_to_pdf',
    name: 'HTML to PDF',
    category: 'convert-compress',
    categoryLabel: 'Convert to PDF',
    description: 'Paste HTML code or upload an HTML file and instantly export a PDF document.',
    badge: 'HTML5',
    colorScheme: {
      bg: 'bg-cyan-500/5 dark:bg-cyan-500/10',
      border: 'border-cyan-500/20 dark:border-cyan-500/30',
